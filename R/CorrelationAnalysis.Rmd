...
corrplot(sampCor, type="upper", order="hclust", col=RColorBrewer::brewer.pal(n=8, name="RdYlBu"), cl.align.text = "l", addCoef.col = "black")
```  
...
**I-Moran** calculated for Flora_Abundance_Norm = `r Moran.I(samp$Flora_Abundance_Norm, samp.dists)$observed`  
