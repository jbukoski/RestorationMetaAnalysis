...
overlay(s1, s2, s3, s4, fun = function(a, b, c, d){(1/(30*2)*((5-0)*(a+b)+(15-5)*(b+c)+(30-15)*(c+d)))}, filename = "../Data/soil_30cm_250m", format = "GTiff", overwrite = TRUE)
rfinal <- raster("soil_30cm_250m.tif")
